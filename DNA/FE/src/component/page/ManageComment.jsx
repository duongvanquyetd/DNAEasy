    ...
    <>
      ...
      <div className="manage-comment-container">
        ...
        <div className="star-summary-row">
          <div className="star-summary-block" onClick={(e) => setSearchQuery(prev => ({ ...prev, star: 1 }))}><span className="star-icon">★</span>  </div>
          <div className="star-summary-block" onClick={(e) => setSearchQuery(prev => ({ ...prev, star: 2 }))}><span className="star-icon">★★</span>  </div>
          <div className="star-summary-block" onClick={(e) => setSearchQuery(prev => ({ ...prev, star: 3 }))}><span className="star-icon">★★★</span> </div>
          <div className="star-summary-block" onClick={(e) => setSearchQuery(prev => ({ ...prev, star: 4 }))}><span className="star-icon">★★★★</span> </div>
          <div className="star-summary-block" onClick={(e) => setSearchQuery(prev => ({ ...prev, star: 5 }))}><span className="star-icon">★★★★★</span>  </div>
        </div>
