      ...
      <div className="servicePage">
        ...
        <section className="banner">
          <div className="bannerContent">
            ...
            <img
              src="https://images.unsplash.com/photo-1643780668909-580822430155?q=80&w=1932&auto=format&fit=crop"
          ...
          <section className="servicesGrid">
            {paginatedServices.map((service) => (
              <div key={service.serviceId} className="serviceCard">
                <img
                  src={service.imageUrls?.[0] || 'https://via.placeholder.com/320x220?text=Service+Image'}
