    ...
    <footer style={styles.footer}>
      ...
      <div style={styles.footerBottom}>
        <p style={styles.footerBottomText}>
          © 2025 Healthy Partners | About Accessibility | Good health | Nondiscrimination statement | Notice of privacy practices | Privacy policy | Surcharge billing | Terms & conditions | Last updated: June 03, 2025
        </p>
      </div>
    </footer>
  );
